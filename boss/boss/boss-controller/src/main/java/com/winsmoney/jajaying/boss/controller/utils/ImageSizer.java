...
public class ImageSizer {
	 ...
	 * @throws IOException
	 */
	public static void resize(final File originalFile, final File resizedFile, final int width, final String format) throws IOException {
		...
		if(imageWidth <= 750){
			ImageIO.write(src, format, resizedFile);
		}else{

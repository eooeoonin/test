...
@Controller
@RequestMapping("/web_mgt/w_app_properties_list")
public class PropertiesController {
   ...
   public  String list(BannerReqVo bannerReqVo, Integer pageNo, Integer pageSize){
	...
	@ResponseBody
	@AduitLog(type = OperType.CREATE, content = "添加置业")
	public BasedataCommonResult<BannerResVo> insert(BannerReqVo bannerReqVo){
	...
	@ResponseBody
	@AduitLog(type = OperType.DELETE, content = "删除置业")
	...
	@ResponseBody	
	@AduitLog(type = OperType.UPDATE, content = "更新置业")

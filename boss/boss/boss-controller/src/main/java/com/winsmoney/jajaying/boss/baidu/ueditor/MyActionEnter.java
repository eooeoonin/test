...
public class MyActionEnter {
	private static final  WinsMoneyLogger logger = WinsMoneyLoggerFactory.getLogger(MyActionEnter.class);
    ...
    public MyActionEnter(HttpServletRequest request, InputStream is, String rootPath) {
        ...
        this.configManager = MyConfigManager.getInstance(is, request, rootPath);

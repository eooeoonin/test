 ...
 */
@Controller
@RequestMapping("/basedata_mgt/pc_notice_list")
public class IPcNoticeController {
...
//	}
	@RequestMapping("/notice/page")
	@ResponseBody
	public  PageInfo<NoticeResVo> listByPlatforms(String platform, String isRollTop, String availableTimeBefore, 
				String availableTimeAfter, String available, Integer pageNo, Integer pageSize){
    	Map<String, Object> params = new HashMap<>();
		if (platform == null || platform.length() == 0) {
			params.put("platforms", Arrays.asList(new String[] {"PC", "PCLIST"}));
		} else {
			params.put("platforms", Arrays.asList(platform));
		}
		params.put("isRollTop", isRollTop); // 只有 platform 属性为 PCLIST时，才生效

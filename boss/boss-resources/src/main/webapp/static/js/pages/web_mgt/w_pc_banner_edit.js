...
$(function () {
	...
	//URL参数
	var id = Request.id;
	var tdUrl = "/web_mgt/w_pc_banner_list/banner/one";
	var tbData = {
		"id": id
	};
...
//			if (_data.type == 12) {
//
//				document.getElementsByName("pcBannerLocation")[0].checked = "checked";
//			} else {
//
//				document.getElementsByName("pcBannerLocation")[1].checked = "checked";
//			}
...
//			document.getElementById("link").value = _data.link;
			document.getElementById("hiddenType").value = _data.type;
...
//		extra1 = document.getElementById("extra1").value;
		...
		$.ajax({
			type: "POST",
			url: "/web_mgt/w_pc_banner_list/banner/update",  //修改
			dataType: "json",
			data: {
				"titile": titile,
				"type": type, 

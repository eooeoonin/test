...
$(function (){
	...
	tableFun("/basedata_mgt/TAG/listData", srhData);
	myPage2();
	...
	_srhBtn.click(function () {
		  var v_subject = $("#subject").val();
			  var srhData2 = {
				...
				tableFun("/basedata_mgt/TAG/listData",srhData2);
				myPage2();	
	});
    		  ...
    		  var _data = data.data.list;
    		     $.each(_data, function (k, v) {
    		    	 ...
    		    	 userCount = v.userCount;
    		          ...
    		          tableBodyHtml += '<td>' + userCount + '</td>';
    		          tableBodyHtml += '<td><a href="../basedata_mgt/TAG_insert_edit.html?id='+T_id+'">编辑</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a  id="'+T_id+'"   onclick="cardDel(\''+T_id+'\')">删除</a></td>';
    		          tableBodyHtml += '</tr>';
    		        });
    		     $("#tcdPagehide").show(); 
	  ...
	  if(sizedata!== 0){
		...
		$tcdPage.createPage({
			...
			backFn : function(q) {
					...
					tableFun("/basedata_mgt/TAG/listData", srhData3);	
			}
		});
}else{
	$("#tcdPagehide").hide();
...
_addmess.click(function(){
	location = "../basedata_mgt/TAG_insert.html";	
});
...
$(function() {
	...
	tableFun("/signet/person_moulage_record/getSealImageRecord", srhData1);
	myPage();
	var _table = $('#table');
...
//								d_sealPassword = v.sealPassword, // 印章密码
						...
						if ("FAIL" == d_transStatus){
							...
							tableBodyHtml += '<td><a href="../signet/moulage_edit.html?&requestId='+d_requestId+'&userId='+d_userId+'">查看</a></td>'
						}
						tableBodyHtml += '</tr>';
					});
...
function myPage() {
	...
	$tcdPage.createPage({
		...
		backFn : function(q) {
			...
			tableFun("/signet/person_moulage_record/getSealImageRecord", srhData2);
		}
	});
}
...
_srhBtn.click(function() {
	...
	tableFun("/signet/person_moulage_record/getSealImageRecord", srhData3);
	myPage();
});

...
$(function() {
	...
	var tdUrl = "../basedata_mgt/isystemconfig_list/selectIsystemConfig";
	var tbData = {
		"id":id
	};
...
$('#updateLoan').click(function(){
	if (!_modalFm1.validationEngine('validate')) {
		...
		$.ajax({
                cache: true,
                type: "POST",
                url:"../basedata_mgt/isystemconfig_list/updateIsystemConfig",
                data:$('#form').serialize(),
                async: false,
                error: function() {
                    alert("修改失败");
                   window.location.href = "../basedata_mgt/isystemconfig_list.html";
                },
                success: function() {
                	  alert("修改成功");
                	  window.location.href = "../basedata_mgt/isystemconfig_list.html";

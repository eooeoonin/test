...
function queryBorrowTable() {
    $.ajax({
        type: "POST",
        url: "/borrow/firstReview/borrowList",
        data: $("#form").serialize(),
        async: false,
        dataType: "json",
        success: function (responseMsg) {
            ...
            if (responseMsg.total != 0) {
                ...
                $.each(responseMsg.list, function (k, v) {
                    ...
                    if (v.status == "PASS_BUS_MANAGER" || v.status == "BACK_RECHECK") {
                        html += "<td><a href='firstReview_I_first_audit.html?borrowerType=" + v.borrowerType + "&borrowId=" + v.id + "'>审核</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href='firstReview_I_first_audit_detail.html?borrowerType=" + v.borrowerType + "&borrowId=" + v.id + "'>详情</a></td>";
                        ...
                        html += "<td><a href='firstReview_I_first_audit_detail.html?borrowerType=" + v.borrowerType + "&borrowId=" + v.id + "'>详情</a></td>";
                    }
                    html += "</tr>";
                });
                $("#tcdPagehide").show();

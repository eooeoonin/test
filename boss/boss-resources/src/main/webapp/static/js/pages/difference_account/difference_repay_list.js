...
var _checkCount1 = '';var _checkCount2 = '';var _checkCount3 = '';var _checkCount4 = '';var _checkCount5 = '';var _checkCount6 = '';var _checkCount7 = '';
        ...
        $.each(data.data.list, function (k, v) {
	          //获取数据
	        	 var u_id = v.id;
	        	  ...
	        	  u_userId = v.userId,
	        	  u_borrowerId = v.borrowerId,
	              u_cashAmount = v.cashAmount.amount,
	              u_principalAmount = v.principalAmount.amount,
	              u_interestAmount = v.interestAmount.amount,
	              u_penaltyAmount = v.penaltyAmount.amount,
	              ...
	              if(u_status == 2){
	            	  ...
	            	  if(u_checkCount.substr(1,1) == '1'){
	            		  ...
	            		  _checkCount2 = '本金入账单边账,';
	            	  }
	            	  if(u_checkCount.substr(2,1) == '1'){
	            		  _checkCount3 = '';
	            	  }if(u_checkCount.substr(2,1) == '2'){
	            		  _checkCount3 = '本金出账错账,';
	            	  }if(u_checkCount.substr(2,1) == '3'){
	            		  _checkCount3 = '本金出账单边账,';
	            	  }
	            	  if(u_checkCount.substr(3,1) == '1'){
	            		  _checkCount4 = '';
	            	  }if(u_checkCount.substr(3,1) == '2'){
	            		  _checkCount4 = '利息入账错账,';
	            	  }if(u_checkCount.substr(3,1) == '3'){
	            		  _checkCount4 = '利息入账单边账,';
	            	  }
	            	  if(u_checkCount.substr(4,1) == '1'){
	            		  _checkCount5 = '';
	            	  }if(u_checkCount.substr(4,1) == '2'){
	            		  _checkCount5 = '利息出账错账,';
	            	  }if(u_checkCount.substr(4,1) == '3'){
	            		  _checkCount5 = '利息出账单边账,';
	            	  }
	            	  if(u_checkCount.substr(5,1) == '1'){
	            		  _checkCount6 = '';
	            	  }if(u_checkCount.substr(5,1) == '2'){
	            		  _checkCount6 = '罚息入账错账,';
	            	  }if(u_checkCount.substr(5,1) == '3'){
	            		  _checkCount6 = '罚息入账单边账,';
	            	  }
	            	  if(u_checkCount.substr(6,1) == '1'){
	            		  _checkCount7 = '';
	            	  }if(u_checkCount.substr(6,1) == '2'){
	            		  _checkCount7 = '罚息出账错账';
	            	  }if(u_checkCount.substr(6,1) == '3'){
	            		  _checkCount7 = '罚息出账单边账';
	            	  }
	              }if(u_status == 3){
	            	  if(u_checkCount.substr(0,1) == '1'){
	            		  _checkCount1 = '';
	              ...
	              _checkCount = _checkCount1 + _checkCount2 + _checkCount3 + _checkCount4 + _checkCount5 + _checkCount6 + _checkCount7;
	          ...
	          tableBodyHtml += '<td>' + u_borrowerId + '</td>';
	          tableBodyHtml += '<td>' + u_cashAmount + '</td>';
	          tableBodyHtml += '<td>' + u_principalAmount + '</td>';
	          tableBodyHtml += '<td>' + u_interestAmount + '</td>';
	          tableBodyHtml += '<td>' + u_penaltyAmount + '</td>';
	          ...
	          if(u_checkCount.substr(0,1) == "2" || u_checkCount.substr(1,1) == "2" || u_checkCount.substr(2,1) == "2" || 
		        	  u_checkCount.substr(3,1) == "2" || u_checkCount.substr(4,1) == "2" || u_checkCount.substr(5,1) == "2" ||
		        	  u_checkCount.substr(6,1) == "2"){

...
//分页
  ...
  function queryBorrow(){
	  $.ajax({
	      type: "POST",
	      url:"/borrow/l_review_list/borrowList",
	      data:$("#form").serialize(),
	      async: false,
	      dataType: "json",
	      success: function(responseMsg) {
	    	  ...
	    	  $.each(responseMsg.list, function (k, v) {
		          html +="<tr>";
		          html +="<td>"+v.id+"</td>";
		          html +="<td><a href='l_review_list_view.html?borrowId="+v.id+"'>"+v.borrowTitle+"</a></td>";
		          ...
		          html +="<td><a href='l_review_list_info.html?borrowId="+v.id+"'>审核</a></td>";
		          html +="</tr>";
	    	  });

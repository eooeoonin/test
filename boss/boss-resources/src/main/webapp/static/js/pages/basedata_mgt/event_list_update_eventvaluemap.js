...
$(function() {
	...
	var tdUrl = "../basedata_mgt/event_list/selectEventValueMapById";
	var tbData = {"id":id};
...
function tableFun(tdUrl, tbData) {
	$.ajax({
		...
		//把商品数据,显示在也页面上
			...
			document.getElementById("inputName").value = data.inputName;
			document.getElementById("outputName").value = data.outputName;
		}
	});
...
$('#updateLoan').click(function(){
	...
	var formdata = $('#form').serialize();
		$.ajax({
                type: "POST",
                url:"../basedata_mgt/event_list/updateEventValueMap",
                data:formdata,
                error: function() {
                    alert("修改失败");

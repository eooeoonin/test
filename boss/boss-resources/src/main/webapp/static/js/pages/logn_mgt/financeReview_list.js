...
function queryBorrowTable() {
    $.ajax({
        type: "POST",
        url: "/borrow/financeReview/borrowList",
        data: $("#form").serialize(),
        async: false,
        dataType: "json",
        success: function (responseMsg) {
            ...
            if (responseMsg.total != 0) {
                ...
                $.each(responseMsg.list, function (k, v) {
                    ...
                    if (v.status == "PASS_RECHECK" || v.status == "BACK_FINAL_CHECK") {
                        html += "<td><a href='financeReview_I_financial_audit.html?borrowerType=" + v.borrowerType + "&borrowId=" + v.id + "'>审核</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href='financeReview_I_financial_audit_detail.html?borrowerType=" + v.borrowerType + "&borrowId=" + v.id + "'>详情</a></td>";
                        ...
                        html += "<td><a href='financeReview_I_financial_audit_detail.html?borrowerType=" + v.borrowerType + "&borrowId=" + v.id + "'>详情</a></td>";
                    }
                    html += "</tr>";
                });
                $("#tcdPagehide").show();

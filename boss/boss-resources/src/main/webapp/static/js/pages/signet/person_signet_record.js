...
$(function() {
	...
	tableFun("/signet/person_signet_record/getPersonSealRecord", srhData1);
	myPage();
	var _table = $('#table');
...
function myPage() {
	...
	$tcdPage.createPage({
		...
		backFn : function(q) {
			...
			tableFun("/signet/person_signet_record/getPersonSealRecord", srhData2);
		}
	});
}
...
_srhBtn.click(function() {
	...
	tableFun("/signet/person_signet_record/getPersonSealRecord", srhData3);
	myPage();
});

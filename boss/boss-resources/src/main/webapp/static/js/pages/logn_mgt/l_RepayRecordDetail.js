...
$(function () {
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        $.each(data.data.list, function (k, v) {
          ...
          if(v.reapyTime){
        	  tableBodyHtml += '<td>' + v.reapyTime + '</td>';
          }else{
        	  tableBodyHtml += '<td></td>';
          }
        ...
        var $tcdPage = $(".tcdPageCode");
          $tcdPage.createPage({
            ...
            backFn: function (p) {
              //点击分页事件
              var srhData = {"pageNo":p,"pageSize":"10","repayRecordId":Request.repayRecordId};
              tableFun("/borrow/l_RepayRecord/getRepayRecordDetail", srhData);
            }
        });
  ...
  var srhData = {"pageNo":1,"pageSize":"10","repayRecordId":Request.repayRecordId};
  tableFun("/borrow/l_RepayRecord/getRepayRecordDetail", srhData);
});

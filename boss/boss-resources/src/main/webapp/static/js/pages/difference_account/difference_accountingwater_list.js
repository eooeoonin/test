...
$(function(){
	...
	var srhData = {"pageNo":"1",
						   ...
						   "inBizType" :"CASH_OUT,CASH_IN,PRINCIPAL_CASH_OUT,PRINCIPAL_CASH_IN、INTEREST_CASH_OUT,INTEREST_CASH_IN,PENALTY_CASH_OUT,PENALTY_CASH_IN",
...
//    	  if(data.data.total!=0){
        ...
        $.each(data.list, function (k, v) {
             ...
             u_subTransCode = v.subTransCode,//子交易码
             u_actionType = v.actionType//资金流向
             ...
             u_transBalanceBefore= v.transBalanceBefore.amount,//易前总金额
             u_amount= v.amount.amount,//交易金额
             u_transBalanceAfter= v.transBalanceAfter.amount,//交易后总金额

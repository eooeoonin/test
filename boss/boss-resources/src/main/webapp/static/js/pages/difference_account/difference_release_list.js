...
var _checkCount1 = '';var _checkCount2 = '';var _checkCount3 = '';var _checkCount4 = '';var _checkCount5 = '';
        ...
        $.each(data.data.list, function (k, v) {
	          //获取数据
	        	 var u_id = v.id;
	              ...
	              _checkCount = _checkCount1 + _checkCount2 + _checkCount3 + _checkCount4 + _checkCount5;
	          ...
	          if(u_checkCount.substr(0,1) == "2" || u_checkCount.substr(1,1) == "2" || u_checkCount.substr(2,1) == "2" || 
		        	  u_checkCount.substr(3,1) == "2" || u_checkCount.substr(4,1) == "2"){

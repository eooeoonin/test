...
$(function () {
  ...
  $(".fancybox").fancybox({openEffect: "none", closeEffect: "none"});
	...
	$.ajax({
		type : "POST",
		url : "/borrow/reReview_I_recheck/audit",
...
$("#addLoan").click(function(){
	...
	$.ajax({
		type : "POST",
		url : "/borrow/reReview_I_recheck/finalReview",
		data : {'id':borrowId,'mark':mark,'reviewCode':reviewCode,'editBy':editBy,'borrowExtendType':'RECHECK'},
		success : function(data) {
			if (data != null && data != "") {
				if (data.resCode == 0) {
					bootbox.alert("操作成功", function(){
						location.href = "/borrow/reReview_list.html";
					});
				}else{

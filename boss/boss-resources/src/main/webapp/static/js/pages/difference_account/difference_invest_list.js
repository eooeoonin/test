...
$(function(){
	...
	var srhData = {"pageNo":"1",
						   ...
						   "inBusType":"INVEST_SUCCESS,INVEST_FAIL",
						   "inStatus":_inStatus2
						  };
...
var _checkCount1 = '';var _checkCount2 = '';var _checkCount3 = '';var _checkCount4 = '';
        ...
        $.each(data.data.list, function (k, v) {
	          //获取数据
	        	 var u_id = v.id;
	              ...
	              u_redMoneyAmount = v.redMoneyAmount.amount,
	              u_tradeTime = v.tradeTime,
	              u_checkCount = v.checkCount,
	              u_status = v.status,
	              u_busType = v.busType
	              
	              if(u_busType == 'INVEST_SUCCESS'){
	            	  if(u_status == '2'){
	              ...
	              _checkCount = _checkCount1 + _checkCount2 + _checkCount3 + _checkCount4;
	          ...
	          tableBodyHtml += '<td>' + u_redMoneyAmount + '</td>';
	          ...
	          if(u_checkCount.substr(0,1) == "2" || u_checkCount.substr(1,1) == '2' || u_checkCount.substr(2,1) == '2' || u_checkCount.substr(3,1) == '2'){

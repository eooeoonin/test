...
$(function () {
	...
	tableFun("../basedata_mgt/operatesystemconfig_list/getSystemConfig", srhData1);	
	myPage2();
	  ...
	  _srhBtn.click(function () {
		  var systemCode = $("#systemCode1").val();
			  ...
			  var srhData2 = {
				...
				tableFun("/basedata_mgt/operatesystemconfig_list/getSystemConfig",srhData2);
				myPage2();
	  });
	   			...
	   			$tcdPage.createPage({
	   				...
	   				backFn : function(q) {
	   					var systemCode1 = $("#systemCode1").val();		  	
	   						...
	   						tableFun("/basedata_mgt/operatesystemconfig_list/getSystemConfig", srhData4);	
	   				}
	   			});
	   	}
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        var s_id = v.id,
          ...
          tableBodyHtml += '<td><a href="../basedata_mgt/operatesystemconfig_list_update_isystemconfig.html?id='+s_id+'&codekey='+s_codeKey+'&systemCode='+s_systemCode+'" style="margin-left:15px;">编辑</a><a  name='+s_id+' href="javascript:" style="margin-left:15px;" onclick="deleteIsystemConfig(this)">删除</a></td>';
          tableBodyHtml += '</tr>';
        });
		...
		function deleteIsystemConfig(sid){
			  bootbox.confirm("确定要删除吗?", function(result){
					if(result){
						$.ajax({
							type : "POST",
							url : "../basedata_mgt/operatesystemconfig_list/deleteIsystemConfig",
							data : {"sid" : sid.name },
							dataType: "json",
							async:false,
							success : function(data) {

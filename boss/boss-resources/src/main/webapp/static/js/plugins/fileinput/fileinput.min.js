...
!function (e) {
  ...
  t = ".fileinput", i = "kvFileinputModal", a = 'style="width:{width};height:{height};"', n = '<param name="controller" value="true" />\n<param name="allowFullScreen" value="true" />\n<param name="allowScriptAccess" value="always" />\n<param name="autoPlay" value="false" />\n<param name="autoStart" value="false" />\n<param name="quality" value="high" />\n', r = '<div class="file-preview-other">\n<span class="{previewFileIconClass}">{previewFileIcon}</span>\n</div>', l = window.URL || window.webkitURL, o = function (e, t, i) {
    ...
    constructor: me, _init: function (t) {
      ...
      t._initZoomButton(), t.$preview.find(".kv-file-remove").each(function () {
        ...
        if (!ae(r) && void 0 !== l) {
          ...
          v = parseInt(v.replace("init_", "")), p = ae(m.config) && ae(m.config[v]) ? null : m.config[v], u = ae(p) || ae(p.extra) ? i : p.extra, "function" == typeof u && (u = u()), s = {
            ...
            url: r, type: "POST", dataType: "json", data: e.extend(!0, {}, {key: l}, u), beforeSend: function (e) {
      ...
      var n, r, l, o, s, d, p, u, f = this, m = function (e, t) {
        !(f[e] instanceof Array) && (f[e] = []), t && t.length && (f[e] = f[e].concat(t))
      };
      ...
      var i, a = this, n = a.$element, r = a.$preview, s = a.reader, d = a.$previewContainer, c = a.$previewStatus, p = a.msgLoading, u = a.msgProgress, f = a.previewInitId, m = t.length, g = a.fileTypeSettings, v = a.filestack.length, h = a.maxFilePreviewSize && parseFloat(a.maxFilePreviewSize), w = r.length && (!h || isNaN(h)), b = function (n, r, l, o) {
        var s = e.extend(!0, {}, a._getOutData({}, {}, t), {id: l, index: o}), d = {id: l, index: o, file: r, files: t};
      ...
      var n, r, l, o, s, d, p = arguments.length > 1, u = i.isUploadable, f = 0, m = p ? t.originalEvent.dataTransfer.files : a.get(0).files, g = i.filestack.length, v = ae(a.attr("multiple")), h = v && g > 0, w = 0, b = function (t, a, n, r) {
        var l = e.extend(!0, {}, i._getOutData({}, {}, m), {id: n, index: r}), o = {id: n, index: r, file: a, files: m};
      ...
      var e = this;
      return e.isDisabled = !0, e._raise("filedisabled"), e.$element.attr("disabled", "disabled"), e.$container.find(".kv-fileinput-caption").addClass("file-caption-disabled"), e.$container.find(".btn-file, .fileinput-remove, .fileinput-upload, .file-preview-frame button").attr("disabled", !0),

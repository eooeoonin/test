...
function renderWindow(node, container, options, windowWidth, windowHeight) {
    ...
    return parser.ready.then(function() {
        ...
        if (options.type === "view") {
            ...
            canvas = crop(renderer.canvas, {width:  options.width != null ? options.width-bounds.left : bounds.width, height: options.height != null ? options.height-bounds.top : bounds.height, top: bounds.top, left: bounds.left, x: clonedWindow.pageXOffset, y: clonedWindow.pageYOffset});
        }
